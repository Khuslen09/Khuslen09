...
```
Flutter · Firebase · Google Maps · Gemini API · SQLite
```

| 기능 | Feature |
|---|---|
| 🗺 CustomPainter + BlendMode로 스크래치 맵 구현 | Scratch map visualization with CustomPainter & BlendMode |
| 🏃 GPS 기반 러닝 추적 (거리 · 페이스 · 경로 히스토리) | Live running tracking with GPS, distance, pace & route history |
| 📌 사진 · 메모 · 카테고리 핀 + Firebase 동기화 | Memory pins with photos, notes, categories & Firebase sync |
| 🤖 Google Places + Gemini API 기반 AI 장소 추천 | AI place recommendations via Google Places + Gemini |
| 💾 SQLite 로컬 우선 아키텍처 + Firestore 동기화 | Local-first architecture with SQLite & Firestore sync |

> 🎓 현재 캡스톤 디자인 프로젝트로 고도화 진행 중 | Currently improving as capstone design project

[![TRACEN](https://img.shields.io/badge/Repository-TRACEN-6B46C1?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Khuslen09/TRACEN)
...
|---|---|---|
| [ML-For-Beginners](https://github.com/Khuslen09/ML) | Microsoft 12주 ML 커리큘럼 실습 | `Python` `Jupyter` `Scikit-Learn` |
| [Hands-on ML3](https://github.com/Khuslen09/jupyternotebooks-of-DL) | Géron 딥러닝 교재 전 챕터 실습 | `TensorFlow` `Keras` |
| [LLaVA](https://github.com/Khuslen09/LLaVA) | NeurIPS'23 비전-언어 멀티모달 연구 | `PyTorch` `LLM` |
| [CAM](https://github.com/Khuslen09/CAM) | NeurIPS 2025 LLM Agentic Memory 연구 | `Python` `NLP` |

---

## 📌 Currently Working On &nbsp;|&nbsp; 지금 하고 있는 것들

- 📱 **TRACEN** 캡스톤 디자인 고도화 중 | Improving TRACEN for capstone design
- 🌐 **LENLAB** 다국어 지식 플랫폼 구축 중 | Building LENLAB multilingual platform
- 📊 데이터 분석 & CS 기초 심화 학습 중 | Studying data analysis & CS fundamentals
- 💼 비즈니스 전략 & 서비스 기획 공부 중 | Studying business strategy & product planning
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=2,12,24&height=120&section=footer"/>

*"Build things. Learn fast. Connect the dots between tech and business. 🚀"*
